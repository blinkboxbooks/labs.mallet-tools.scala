...
public class TopicModel {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length < 1) {
            System.err.println("Usage: TopicModel <csv file>");
            System.exit(-1);
        }
        ...
        model.setNumIterations(1000/*50*/);
        model.estimate();

        // Write model to file.
        File modelFile = new File("/Users/jans/src/research/mallet-tools/src/main/resources/TopicModel.dump");
